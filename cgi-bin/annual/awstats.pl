...
# ChangeLog: Changes large html codeblock for custom dropdown menu at top of annual results page
# 
#
#
#
...
sub HTMLTopBanner{
	...
	#BG remove top section to put in custom dropdown menu
...
# "<input type=\"submit\" value=\" $Message[115] \" class=\"aws_button\" />";
    ...
    #BG remove whole block of HTML above to replace with the custom dropdown menu html
    #####################################################
    #####################################################
    #####################################################
    ...
    print 
    '<form name="FormDateFilter" action="" style="padding: 0px 0px 0px 0px; margin-top: 0">
    <table class="aws_border" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr><td>
    <table class="aws_data sortable" border="0" cellpadding="1" cellspacing="0" width="100%">
    <tr><td class="aws" valign="middle"><b>Statistics for:</b>&nbsp;</td><td class="aws" valign="middle">
    <span style="font-size: 14px;">epa-intranet.epa.gov</span></td><td align="right" rowspan="3"></td></tr>';
    ...
    print          
    '</td></tr>
    <tr><td class="aws" valign="middle"><b>Go to Month:</b></td><td class="aws" valign="middle">

    <select class="aws_formfield" name="month" id="selMonth">
...
"$Message[81] (Only Shown in Full List Table) &nbsp; - &nbsp; <a href=\"" #BG Added text
	  . (
		$ENV{'GATEWAY_INTERFACE'}
		  || !$StaticLinks
