...
function checkForPageLoc(address) {
...
//Dropdown Menu Functions Section End
        ...
        initSort: function(noCallback, ident) {
                ...
                if(dataObj.thList.length > 1) {
                        ...
                        if(!identical) {
                                ...
                                //BG added - changed hyphen to underscore in favour reverse
                                if(thNode.className.search(/(^|\s)favour_reverse($|\s)/) != -1) {
